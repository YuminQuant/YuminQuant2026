...
use crate::factor::common::stock_daily_raw_ids::SUBRK_5MIN_RAW_ID;
...
pub struct StockDailySubrk5min;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailySubrk5min)
}

impl Factor for StockDailySubrk5min {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "subrk_5min".to_string(),
            aliases: vec!["subRK_5min".to_string(), "SUBRK_5MIN".to_string()],
            name: "subRK 5min".to_string(),
            asset_class: AssetClass::Stock,
            frequency: Frequency::Daily,
            version: VERSION.to_string(),
            tags: subr_tags(),
            description: "Downsampled 5-minute realized kurtosis, smoothed over 5 days, z-scored, and neutralized by SIZE and SW sector.".to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        compute_subr_factor(self.spec(), SUBRK_5MIN_RAW_ID, data)
    }
}
