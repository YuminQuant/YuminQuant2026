...
pub struct StockDailyWQAlpha042;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyWQAlpha042)
}

impl Factor for StockDailyWQAlpha042 {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "WQAlpha042".to_string(),
            aliases: Vec::new(),
            name: "WQAlpha042".to_string(),
            ...
            tags: ["worldquant101alpha", "price_volume", "daily"]
                ...
                .collect(),
            description: "WQAlpha042".to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        ...
        let denominator = vwap
            .zip_binary(&close, add)?
            .cs(|values| cs_pctrank(values, true))?;
