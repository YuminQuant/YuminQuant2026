...
pub struct StockDailyWQAlpha033;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyWQAlpha033)
}

impl Factor for StockDailyWQAlpha033 {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "WQAlpha033".to_string(),
            aliases: Vec::new(),
            name: "WQAlpha033".to_string(),
            ...
            tags: ["worldquant101alpha", "price_volume", "daily"]
                ...
                .collect(),
            description: "WQAlpha033".to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        ...
        let raw = panel
            .column("open")?
            .zip_binary(&panel.column("close")?, |open, close| {
                div(open, close).map(|value| -(1.0 - value))
            })?;
