...
pub const XYZQ_SPILL_RV_RAW_ID: &str = "daily_xyzq_spill_rv";
pub const XYZQ_SPILL_RETSKEW_RAW_ID: &str = "daily_xyzq_spill_retskew";
pub const XYZQ_SPILL_AFTVOLRATIO_RAW_ID: &str = "daily_xyzq_spill_aftvolratio";
pub const XYZQ_SPILL_VARVAR_RAW_ID: &str = "daily_xyzq_spill_varvar";
pub const XYZQ_SPILL_RETVOLCORR_RAW_ID: &str = "daily_xyzq_spill_retvolcorr";
pub const XYZQ_SPILL_MORVOLRATIO_RAW_ID: &str = "daily_xyzq_spill_morvolratio";
pub const XYZQ_SPILL_TAYLORRET_RAW_ID: &str = "daily_xyzq_spill_taylorret";
pub const XYZQ_SPILL_MORNINGRET_RAW_ID: &str = "daily_xyzq_spill_morningret";
pub const XYZQ_SPILL_OUTBOUNDRET_RAW_ID: &str = "daily_xyzq_spill_outboundret";
pub const XYZQ_SPILL_RVDIFF_RAW_ID: &str = "daily_xyzq_spill_rvdiff";
pub const XYZQ_SPILL_MORVOLMINUSAFTVOL_RAW_ID: &str = "daily_xyzq_spill_morvolminusaftvol";
pub const XYZQ_SPILL_VARVARSIGNSUB_RAW_ID: &str = "daily_xyzq_spill_varvarsignsub";
...
pub const AMIHUD_1MIN_RAW_ID: &str = "daily_amihud_1min";
pub const LIQRESID_RAW_ID: &str = "daily_liqresid";
pub const APBETA1_RAW_ID: &str = "daily_apbeta1";
pub const APBETA2_RAW_ID: &str = "daily_apbeta2";
pub const APBETA3_RAW_ID: &str = "daily_apbeta3";
pub const APBETA4_RAW_ID: &str = "daily_apbeta4";
pub const GAMMA1_RAW_ID: &str = "daily_gamma1";
pub const GAMMA2_RAW_ID: &str = "daily_gamma2";
pub const GAMMA3_RAW_ID: &str = "daily_gamma3";
pub const GAMMA4_RAW_ID: &str = "daily_gamma4";
pub const CLOSE_APBETA4_RAW_ID: &str = "daily_close_apbeta4";
pub const RV_APBETA3_RAW_ID: &str = "daily_rv_apbeta3";
pub const CLOSEVOLCORR_GAMMA3_RAW_ID: &str = "daily_closevolcorr_gamma3";
pub const RSI_GAMMA3_RAW_ID: &str = "daily_rsi_gamma3";
pub const VARVAR_GAMMA3_RAW_ID: &str = "daily_varvar_gamma3";
pub const VOLRATIO_GAMMA4_RAW_ID: &str = "daily_volratio_gamma4";

pub const APBETA2_5M_N_RAW_ID: &str = "daily_apbeta2_5m_n";
pub const APBETA2_5M_SUM_X_RAW_ID: &str = "daily_apbeta2_5m_sum_x";
pub const APBETA2_5M_SUM_Y_RAW_ID: &str = "daily_apbeta2_5m_sum_y";
pub const APBETA2_5M_SUM_XY_RAW_ID: &str = "daily_apbeta2_5m_sum_xy";
pub const APBETA2_5M_SUM_Z_RAW_ID: &str = "daily_apbeta2_5m_sum_z";
pub const APBETA2_5M_SUM_Z2_RAW_ID: &str = "daily_apbeta2_5m_sum_z2";
pub const APBETA3_5M_N_RAW_ID: &str = "daily_apbeta3_5m_n";
pub const APBETA3_5M_SUM_X_RAW_ID: &str = "daily_apbeta3_5m_sum_x";
pub const APBETA3_5M_SUM_Y_RAW_ID: &str = "daily_apbeta3_5m_sum_y";
pub const APBETA3_5M_SUM_XY_RAW_ID: &str = "daily_apbeta3_5m_sum_xy";
pub const APBETA3_5M_SUM_Z_RAW_ID: &str = "daily_apbeta3_5m_sum_z";
pub const APBETA3_5M_SUM_Z2_RAW_ID: &str = "daily_apbeta3_5m_sum_z2";
