...
pub struct StockDailyWQAlpha043;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyWQAlpha043)
}

impl Factor for StockDailyWQAlpha043 {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "WQAlpha043".to_string(),
            aliases: Vec::new(),
            name: "WQAlpha043".to_string(),
