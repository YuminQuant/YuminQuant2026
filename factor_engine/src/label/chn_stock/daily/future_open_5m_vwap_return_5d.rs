...
pub struct StockDailyFutureOpen5mVwapReturn5d;

pub fn create() -> Box<dyn Label> {
    Box::new(StockDailyFutureOpen5mVwapReturn5d)
}

impl Label for StockDailyFutureOpen5mVwapReturn5d {
    fn spec(&self) -> LabelSpec {
        LabelSpec {
            id: "future_open_5m_vwap_return_5d".to_string(),
            aliases: Vec::new(),
            name: "Stock future 5-day opening 5-minute adjusted VWAP".to_string(),
            ...
            .collect(),
            description:
                "Future adjusted return from t+1 09:31-09:35 VWAP to t+6 09:31-09:35 VWAP."
                    .to_string(),
