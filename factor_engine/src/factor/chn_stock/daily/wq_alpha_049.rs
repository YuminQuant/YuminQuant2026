...
pub struct StockDailyWQAlpha049;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyWQAlpha049)
}

impl Factor for StockDailyWQAlpha049 {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "WQAlpha049".to_string(),
            aliases: Vec::new(),
            name: "WQAlpha049".to_string(),
            ...
            tags: ["worldquant101alpha", "price_volume", "daily", "deprecated"]
                ...
                .collect(),
            description: "WQAlpha049".to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        ...
        let factor = slope.zip_binary(&delta1, |slope, delta1| match clean(slope) {
            Some(slope) if slope < -0.1 => Some(1.0),
