...
const RAW_ID: &str = "open_5m_vwap";
const RAW_VERSION: &str = "0.2.0";
const START_TIME: &str = "09:31:00";
const END_TIME: &str = "09:35:00";

pub struct StockDailyFutureOpen5mVwapReturn1d;

pub fn create() -> Box<dyn Label> {
    Box::new(StockDailyFutureOpen5mVwapReturn1d)
}

impl Label for StockDailyFutureOpen5mVwapReturn1d {
    fn spec(&self) -> LabelSpec {
        LabelSpec {
            id: "future_open_5m_vwap_return_1d".to_string(),
            aliases: Vec::new(),
            name: "Stock future 1-day opening 5-minute adjusted VWAP".to_string(),
            ...
            .collect(),
            description:
                "Future adjusted return from t+1 09:31-09:35 VWAP to t+2 09:31-09:35 VWAP."
                    .to_string(),
