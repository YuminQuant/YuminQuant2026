...
impl Label for StockDailyFutureOpenReturn20d {
    fn spec(&self) -> LabelSpec {
        LabelSpec {
            ...
            aliases: Vec::new(),
            name: "Stock future 20-day open-to-open return".to_string(),
            ...
            tags: ["label", "future_return", "open_to_open", "daily"]
                ...
                .collect(),
            description: "Future return from t+1 open to t+21 open.".to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<LabelSeries> {
        ...
        let label = open.ts(|values| future_open_return(values, 21))?;
