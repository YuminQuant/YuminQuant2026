...
use crate::factor::chn_stock::daily::treat_same::FAIR_VOLATILITY_RAW_ID;
...
pub struct StockDailyTreatSameVolatilityFair;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyTreatSameVolatilityFair)
}

impl Factor for StockDailyTreatSameVolatilityFair {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "treat_same_volatility_fair".to_string(),
            aliases: Vec::new(),
            name: "Treat Same Volatility Fair".to_string(),
            ...
            .collect(),
            description:
                "Temporary output of the volatility fairness branch before Treat Same composite."
                    .to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        ...
        let factor = fair_volatility.ts(|values| ts_mean(values, WINDOW, 1))?;
