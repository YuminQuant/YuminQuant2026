...
pub struct StockDailyWQAlpha038;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyWQAlpha038)
}

impl Factor for StockDailyWQAlpha038 {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "WQAlpha038".to_string(),
            aliases: Vec::new(),
            name: "WQAlpha038".to_string(),
            ...
            tags: ["worldquant101alpha", "price_volume", "daily"]
                ...
                .collect(),
            description: "WQAlpha038".to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        ...
        let part2 = close
            .zip_binary(&panel.column("open")?, div)?
            .cs(|values| cs_pctrank(values, true))?;
