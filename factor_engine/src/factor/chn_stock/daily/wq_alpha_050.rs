...
pub struct StockDailyWQAlpha050;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyWQAlpha050)
}

impl Factor for StockDailyWQAlpha050 {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "WQAlpha050".to_string(),
            aliases: Vec::new(),
            name: "WQAlpha050".to_string(),
            ...
            tags: ["worldquant101alpha", "price_volume", "daily"]
                ...
                .collect(),
            description: "WQAlpha050".to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        ...
        let factor = rank_volume
            .ts_binary(&rank_vwap, |volume, vwap| ts_corr(volume, vwap, 5, 5))?
            .cs(|values| cs_pctrank(values, true))?
            .ts(|values| ts_max(values, 5, 5))?
