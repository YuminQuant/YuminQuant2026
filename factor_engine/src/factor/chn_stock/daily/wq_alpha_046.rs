...
pub struct StockDailyWQAlpha046;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyWQAlpha046)
}

impl Factor for StockDailyWQAlpha046 {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "WQAlpha046".to_string(),
            aliases: Vec::new(),
            name: "WQAlpha046".to_string(),
            ...
            tags: ["worldquant101alpha", "price_volume", "daily"]
                ...
                .collect(),
            description: "WQAlpha046".to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        ...
        let factor = slope.zip_binary(&delta1, |slope, delta1| match clean(slope) {
            Some(slope) if slope > 0.25 => Some(-1.0),
            Some(slope) if slope < 0.0 => Some(1.0),
