...
pub struct StockDailyWQAlpha031;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyWQAlpha031)
}

impl Factor for StockDailyWQAlpha031 {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "WQAlpha031".to_string(),
            aliases: Vec::new(),
            name: "WQAlpha031".to_string(),
            ...
            tags: ["worldquant101alpha", "price_volume", "daily"]
                ...
                .collect(),
            description: "WQAlpha031".to_string(),
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        ...
        let part2 = close
            ...
            .cs(|values| cs_pctrank(values, true))?;
        let part3 = adv20
            .ts_binary(&low, |adv20, low| ts_corr(adv20, low, 12, 12))?
            .cs(cs_scale)?
            .map_values(sign_value);
        let factor = part1.zip_binary(&part2, add)?.zip_binary(&part3, add)?;
