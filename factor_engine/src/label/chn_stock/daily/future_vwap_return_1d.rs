...
pub struct StockDailyFutureVwapReturn1d;

pub fn create() -> Box<dyn Label> {
    Box::new(StockDailyFutureVwapReturn1d)
}

impl Label for StockDailyFutureVwapReturn1d {
    fn spec(&self) -> LabelSpec {
        LabelSpec {
            id: "future_vwap_return_1d".to_string(),
            aliases: Vec::new(),
            name: "Stock future 1-day adjusted daily VWAP".to_string(),
            ...
            tags: ["label", "future_return", "adjusted", "daily_vwap", "daily"]
                ...
                .collect(),
            description:
                "Future adjusted daily VWAP return from t+1 full-day VWAP to t+2 full-day VWAP."
                    .to_string(),
            dependencies: vec![
