...
pub struct StockDailyTrcf;

pub fn create() -> Box<dyn Factor> {
    Box::new(StockDailyTrcf)
}

impl Factor for StockDailyTrcf {
    fn spec(&self) -> FactorSpec {
        FactorSpec {
            id: "trcf".to_string(),
            aliases: vec!["TRCF".to_string()],
            name: "TRCF".to_string(),
            ...
            .collect(),
            description: "Turnover Rate Convergence Factor based on the cross-period standard deviation of turnover moving averages, neutralized by Barra SIZE and SW sector.".to_string(),
            dependencies: vec![
    ...
    fn compute(&self, _context: &FactorContext, data: &DataPool) -> Result<FactorSeries> {
        ...
        let raw_factor = convergence_score(&turnover)?;
